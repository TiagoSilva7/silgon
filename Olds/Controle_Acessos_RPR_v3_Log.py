...
logging.basicConfig(
                    ...
                    datefmt='%d-%b-%y %H:%M:%S',
                    style="{",
                    filename=f"Logging_message_{data_log}.log",
                    filemode="w",
                    )
...
teradata_codigo_grupo_unico = teradata_cd_group['cd_grupo']
...
teradata_cpf_unico_teradata = teradata_cd_group['cpf_usuario']
