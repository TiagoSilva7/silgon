...
def ensure_patients_schema():
    ...
    try:
        ...
        if not cols:
            ...
            return
        expected = {
            'cpf': 'TEXT', 'name': 'TEXT', 'birth_date': 'TEXT', 'sex': 'TEXT', 'gender': 'TEXT',
            'marital_status': 'TEXT', 'profession': 'TEXT', 'phone': 'TEXT', 'whatsapp': 'TEXT',
            'tel_home': 'TEXT', 'tel_cell': 'TEXT', 'tel_msg': 'TEXT', 'contact_name': 'TEXT',
            'email': 'TEXT', 'cep': 'TEXT', 'address': 'TEXT', 'city': 'TEXT', 'state': 'TEXT',
            'number': 'TEXT', 'complement': 'TEXT', 'prof': 'TEXT', 'age': 'INTEGER', 'weight': 'REAL', 'height': 'REAL',
            'emergency_contact': 'TEXT', 'emergency_phone': 'TEXT', 'emergency_relationship': 'TEXT',
            'insurance': 'TEXT', 'insurance_number': 'TEXT', 'private_patient': 'TEXT',
            'legal_guardian': 'TEXT', 'legal_guardian_cpf': 'TEXT', 'legal_guardian_phone': 'TEXT',
            'doctor_name': 'TEXT', 'doctor_crm': 'TEXT', 'medical_diagnosis': 'TEXT', 'cid': 'TEXT',
            'evaluation_date': 'TEXT', 'care_modality': 'TEXT', 'care_location': 'TEXT',
            'physiotherapist_name': 'TEXT', 'physiotherapist_crefito': 'TEXT', 'registration_notes': 'TEXT'
        }
...
def patients():
    ...
    if request.method == 'POST':
        ...
        patient_values = {
            ...
            'tel_home': data.get('phone'),
            'tel_cell': data.get('phone'),
            'tel_msg': data.get('whatsapp'),
            'contact_name': data.get('emergency_contact'),
            ...
            'private_patient': data.get('private_patient'),
            'legal_guardian': data.get('legal_guardian'),
            'legal_guardian_cpf': data.get('legal_guardian_cpf'),
            'legal_guardian_phone': data.get('legal_guardian_phone'),
            'doctor_name': data.get('doctor_name'),
            'doctor_crm': data.get('doctor_crm'),
            'medical_diagnosis': data.get('medical_diagnosis'),
            'cid': data.get('cid'),
            'evaluation_date': data.get('evaluation_date'),
            'care_modality': data.get('care_modality'),
            'care_location': data.get('care_location'),
            'physiotherapist_name': data.get('physiotherapist_name'),
            'physiotherapist_crefito': data.get('physiotherapist_crefito'),
            'registration_notes': data.get('registration_notes')
        }
        fields = list(patient_values.keys())
        values = [patient_values[f] for f in fields]
        cur = db.cursor()
        if pid:
